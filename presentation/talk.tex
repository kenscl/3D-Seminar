...
\begin{minipage}{0.49\textwidth}
    \begin{figure}
        \includegraphics[width=\linewidth]{480px-Delaunay_circumcircles_vectorial.svg.png} 
    \end{figure}
\end{minipage}
\begin{minipage}{0.50\textwidth}
    \begin{figure}[ht]
        \centering
        \animategraphics[width=\linewidth,autoplay,loop]{12}{kiemra_mesher_gif/kimeravio_release-}{0}{258}
    \end{figure}
\end{minipage}
\end{frame}
